...
const energyEducationWebsiteString = buildAnAtomStrings.energyEducationWebsite;
...
function PhetMenu( sim, phetButton, tandem, options ) {
  ...
  const itemDescriptors = [
    ...
    {
      text: energyEducationWebsiteString,
      present: true,//isPhETBrand
      callback: function() {
        if ( !fuzzes ) {
          // Open locale-specific PhET home page. If there is no website translation for locale, fallback will be handled by server. See joist#97.
          openPopup( 'https://energyeducation.ca/encyclopedia/Main_Page' );
        }
      }
    },
    {
