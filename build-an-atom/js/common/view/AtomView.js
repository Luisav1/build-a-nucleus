...
function AtomView( model, tandem ) {
 ...
 /// model.particleAtom.electrons.lengthProperty.link( updateElectronVisibility );
  ...
  const particleAtomDisplay = new ParticleAtomDisplay( model.particleAtom, NUM_NUCLEON_LAYERS, tandem, {
  ...
  const numDividerLines = 0;//sinc etook out ion/neutral this is now 1 instead of 2
